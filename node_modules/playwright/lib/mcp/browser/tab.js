...
class LogFile {
  constructor(context, filePrefix, title) {
  ...
  async _write(wallTime, text) {
    if (this._stopped)
      return;
    this._file ??= await this._context.outputFile((0, import_utils2.dateAsFileName)(this._filePrefix, "log", new Date(this._startTime)), { origin: "code", title: this._title });
